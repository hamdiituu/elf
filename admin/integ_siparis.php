...
$page_title = 'Siparişler (Integ) - Vira Stok Sistemi';
$db = getDB();
...
// Get all records
$records = $db->query("SELECT * FROM integ_siparis ORDER BY id DESC")->fetchAll(PDO::FETCH_ASSOC);
    ...
    <main class="flex-1 overflow-y-auto">
        <div class="py-6">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
                <h1 class="text-3xl font-bold text-foreground mb-8">Siparişler (Integ)</h1>
                                ...
                                <table class="w-full border-collapse">
                                    <thead>
                                        <tr class="border-b border-border">
                                            ...
                                            <th class="h-12 px-4 text-left align-middle font-medium text-muted-foreground text-sm">Toplaniyor mu</th>
