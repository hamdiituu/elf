...
<aside class="hidden md:flex md:flex-shrink-0">
    <div class="flex flex-col w-64 border-r border-border bg-background">
        ...
        <nav class="flex-1 space-y-1 px-3 py-4 overflow-y-auto">
            ...
            <!-- Divider - System Management -->
            <div class="px-3 py-2">
                <div class="border-t border-border"></div>
                <div class="mt-2 px-2">
                    <span class="text-xs font-semibold text-muted-foreground uppercase tracking-wider">System Management</span>
                </div>
            </div>
            
            <a
                href="users.php"
                class="flex items-center px-3 py-2 text-sm font-medium rounded-md transition-colors <?php echo $current_page == 'users.php' ? 'text-foreground bg-accent' : 'text-muted-foreground hover:bg-accent hover:text-foreground'; ?>"
            >
                <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
